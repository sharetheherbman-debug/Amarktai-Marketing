...
GLOBAL_ENV_KEYS: list[dict[str, Any]] = [
    ...
    {
        "key_name": "GENX_MODEL_IMAGE",
        "label": "GenX Image Model Override",
        "group": "GenX runtime",
        "required": False,
        "secret": False,
    },
    {
        "key_name": "GENX_MODEL_VIDEO",
        "label": "GenX Video Model Override",
        "group": "GenX runtime",
        "required": False,
        "secret": False,
    },
    {
        "key_name": "GENX_MODEL_AUDIO",
        "label": "GenX Audio Model Override",
        "group": "GenX runtime",
        "required": False,
        "secret": False,
    },
    {
        "key_name": "GENX_MODEL_AVATAR",
        "label": "GenX Avatar Model Override",
        "group": "GenX runtime",
        "required": False,
        "secret": False,
    },
